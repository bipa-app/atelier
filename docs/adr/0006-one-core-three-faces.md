...
- CLI-first, extract a library later: rejected — extraction after the fact is the classic painful path, and the embedders this project exists for (bip, Buzz, satoshi-holmes) need the library from day one.
