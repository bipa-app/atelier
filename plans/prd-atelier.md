...
An open-source tool (`ws` CLI + Rust libraries) where a workspace is a named, versioned body of any work content, shared by humans and agents through the same contracts:
